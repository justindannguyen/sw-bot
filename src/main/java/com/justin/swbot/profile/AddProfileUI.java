...
public class AddProfileUI extends JFrame {
  ...
  private JPanel getPanel() {
    if (panel == null) {
      ...
      panel.add(getLblNetworkDelayIndicator(), "cell 0 13");
      panel.add(getNetworkDelayBoxPicker(), "cell 1 13,grow");
      panel.add(getLblUnstableNetworkIndicator(), "cell 0 14");
      panel.add(getUnstableNetworkBoxPicker(), "cell 1 14,grow");
    }
    return panel;
  }
