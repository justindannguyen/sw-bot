...
public class AddProfileControllerAction implements AddProfileModelListener, ActionListener,
  ...
  public void valueChanged(final Object source, final Object newValue) {
    ...
    if (source == ui.getReplayPointPicker()) {
      ...
      model.setReplayBattleIndicator((MemImage) newValue);
    } else if (source == ui.getStartBattleBoxPicker()) {
      model.setStartBattleIndicator((MemImage) newValue);
    } else if (source == ui.getEndBattleBoxPicker()) {
      model.setBattleEndIndicator((MemImage) newValue);
    } else if (source == ui.getRuneRewardBoxPicker()) {
      model.setRuneRewardIndiator((MemImage) newValue);
    } else if (source == ui.getConfirmSellRuneBoxPicker()) {
      model.setConfirmSellRuneIndicator((MemImage) newValue);
    } else if (source == ui.getOtherRewardBoxPicker()) {
      model.setOtherRewardIndicator((MemImage) newValue);
    } else if (source == ui.getManualAttBoxPicker()) {
      model.setManualAttackIndicator((MemImage) newValue);
    } else if (source == ui.getNoEnergyBoxPicker()) {
      model.setNoEnergyIndicator((MemImage) newValue);
    } else if (source == ui.getNetworkDelayBoxPicker()) {
      model.setNetworkDelayIndicator((MemImage) newValue);
    } else if (source == ui.getUnstableNetworkBoxPicker()) {
      model.setNetworkUnstableIndicator((MemImage) newValue);
      ...
      model.setSixStarRuneIndicator((MemImage) newValue);
    } else if (source == ui.getFiveStarRuneBoxPicker()) {
      model.setFiveStarRuneIndicator((MemImage) newValue);
      ...
      model.setStoneRewardIndicator((MemImage) newValue);
    } else if (source == ui.getInBattleImagePicker()) {
      model.setInBattleIndicator((MemImage) newValue);
      ...
      model.setConfirmSellStoneIndicator((MemImage) newValue);
    }
  }
